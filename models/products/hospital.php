<div class="col-lg-4 col-md-6 portfolio-item filter-hospital">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-hospital">
              <div class="portfolio-content h-100">
                <img src="assets/img/hospital/hospital3.jpg" class="img-fluid" alt="">
                <div class="portfolio-info">
                  <h4></h4>
                  <p>Hospital furniture</p>
                  <a href="assets/img/hospital/hospital3.jpg" title="" data-gallery="portfolio-gallery-repairs" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                </div>
              </div>
            </div><!-- End Projects Item -->
